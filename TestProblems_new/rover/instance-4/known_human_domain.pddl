...
(define (domain test_domain)
    ...
    (:action navigate
     ...
     :precondition (and (can_traverse ?x ?y ?z) (available ?x) (visible ?y ?z))
     :effect (and
        (at ?x ?z)
        (not (at ?x ?y)))
    )
    ...
    (:action calibrate
     ...
     :precondition (and (equipped_for_imaging ?r) (calibration_target ?i ?t) (visible_from ?t ?w) (on_board ?i ?r))
     :effect (and
        (calibrated ?i ?r))
    )
    ...
    (:action communicate_rock_data
     :parameters (?r - rover ?l - lander ?p - waypoint ?w - waypoint ?y - waypoint)
     :precondition (and (at_lander ?l ?y) (have_rock_analysis ?r ?p) (visible ?w ?y) (available ?r) (channel_free ?l))
     :effect (and
        (channel_free ?l)
