...
(define (domain test_domain)
    ...
    (:action take_image
     ...
     :precondition (and (calibrated ?i ?r) (on_board ?i ?r) (equipped_for_imaging ?r) (supports ?i ?m) (visible_from ?o ?p))
     :effect (and
        (have_image ?r ?o ?m)
        (not (calibrated ?i ?r)))
    )
    ...
    (:action communicate_soil_data
     ...
     :precondition (and (at_lander ?l ?y) (have_soil_analysis ?r ?p) (visible ?w ?y) (available ?r) (channel_free ?l))
     :effect (and
        (channel_free ?l)
